...
### :pushpin: 2. [Read With Me](https://github.com/thdqudgns/ReadWithMe1)
...
#### 역할
조장, 명언게시판 및 관리, 후기게시판 및 관리, 신고관리, Github&소스트리 사용법 전달, 네이버 API를 이용한 도서검색, 에러페이지 처리, 동작 오류 점검, 메인, 관리자 화면 UI
